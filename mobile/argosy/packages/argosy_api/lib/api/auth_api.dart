...
class AuthApi {
  ...
  ///
  /// Removes the account with its profiles, devices, watch history, vaults and preferences (DB cascade). The instance owner's account can't be deleted. Prefer disabling unless the person is truly gone — deletion is unrecoverable. 
  ///
  /// Note: This method returns the HTTP [Response].
  ///
  /// Parameters:
