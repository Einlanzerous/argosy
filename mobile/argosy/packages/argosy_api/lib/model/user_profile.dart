  ...
  static UserProfile? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        ...
        assert(json.containsKey(r'role'), 'Required key "UserProfile[role]" is missing from JSON.');
        assert(json[r'role'] != null, 'Required key "UserProfile[role]" has a null value in JSON.');
        return true;
      }());
