...
class AccountUpdateRequest {
  ...
  @override
  String toString() => 'AccountUpdateRequest[disabled=$disabled]';
  ...
  static AccountUpdateRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'disabled'), 'Required key "AccountUpdateRequest[disabled]" is missing from JSON.');
        assert(json[r'disabled'] != null, 'Required key "AccountUpdateRequest[disabled]" has a null value in JSON.');
        return true;
      }());
